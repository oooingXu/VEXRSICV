...
#define CSR_ETHPHY_CRG_TXDELAY_TAPS_ADDR (CSR_BASE + 0x1004L)
#define CSR_ETHPHY_CRG_TXDELAY_TAPS_SIZE 1
...
#define CSR_SDRAM_DFII_PI0_RDDATA_ADDR (CSR_BASE + 0x2824L)
#define CSR_SDRAM_DFII_PI0_RDDATA_SIZE 4
#define CSR_SDRAM_DFII_PI1_COMMAND_ADDR (CSR_BASE + 0x2834L)
#define CSR_SDRAM_DFII_PI1_COMMAND_SIZE 1
#define CSR_SDRAM_DFII_PI1_COMMAND_ISSUE_ADDR (CSR_BASE + 0x2838L)
#define CSR_SDRAM_DFII_PI1_COMMAND_ISSUE_SIZE 1
#define CSR_SDRAM_DFII_PI1_ADDRESS_ADDR (CSR_BASE + 0x283cL)
#define CSR_SDRAM_DFII_PI1_ADDRESS_SIZE 1
#define CSR_SDRAM_DFII_PI1_BADDRESS_ADDR (CSR_BASE + 0x2840L)
#define CSR_SDRAM_DFII_PI1_BADDRESS_SIZE 1
#define CSR_SDRAM_DFII_PI1_WRDATA_ADDR (CSR_BASE + 0x2844L)
#define CSR_SDRAM_DFII_PI1_WRDATA_SIZE 4
#define CSR_SDRAM_DFII_PI1_RDDATA_ADDR (CSR_BASE + 0x2854L)
...
/* WATCHDOG0 Registers */
#define CSR_WATCHDOG0_BASE (CSR_BASE + 0x4000L)
#define CSR_WATCHDOG0_CONTROL_ADDR (CSR_BASE + 0x4000L)
#define CSR_WATCHDOG0_CONTROL_SIZE 1
#define CSR_WATCHDOG0_CYCLES_ADDR (CSR_BASE + 0x4004L)
#define CSR_WATCHDOG0_CYCLES_SIZE 1
#define CSR_WATCHDOG0_REMAINING_ADDR (CSR_BASE + 0x4008L)
#define CSR_WATCHDOG0_REMAINING_SIZE 1
#define CSR_WATCHDOG0_EV_STATUS_ADDR (CSR_BASE + 0x400cL)
#define CSR_WATCHDOG0_EV_STATUS_SIZE 1
#define CSR_WATCHDOG0_EV_PENDING_ADDR (CSR_BASE + 0x4010L)
#define CSR_WATCHDOG0_EV_PENDING_SIZE 1
#define CSR_WATCHDOG0_EV_ENABLE_ADDR (CSR_BASE + 0x4014L)
...
static inline uint32_t ethphy_crg_txdelay_taps_read(void) {
	return csr_read_simple((CSR_BASE + 0x1004L));
}
static inline void ethphy_crg_txdelay_taps_write(uint32_t v) {
