...
class Briey(val config: BrieyConfig) extends Component{
  ...
  /*wxz*/
  val mem_clk = ClockDomain.external("mem_clk", config = ClockDomainConfig(resetKind = ASYNC, resetActiveLevel = LOW))
  ...
  val axi = new ClockingArea(axiClockDomain) {
    ...
    axiCrossbar.addConnections(
      ...
      vgaCtrl.io.axi  -> List(            sdramCtrl.io.axi, ddr3Ctrl.io.axi)                    /*wxz*/
    )
