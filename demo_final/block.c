...
extern struct J_Sl6Dag5p sajdkj1;
void RsBhhiFFvE();
void fjksdfj(int, int, int, int);
void jsuwjsuw21(struct Vyi8XZjDoj, int, uint32_t);
void fhsjkwiwiw11(char, int, int);
void jkjk91010(const char*, int, int);
enum uint32_t {
  qBLBhlntx_ = 0xffffff,
  JCyb92PO2X = 0xf44336,
  WxSdxkcUJN = 0xffeb3b,
...
void fhsjkwiwiw11(char ltHfkAWT49, int PNOyOWxJpK, int JIGYRzzmas) {
  ...
  for (lN3Q1bY4Lc = 0; lN3Q1bY4Lc < 16; lN3Q1bY4Lc ++) {
    for (K8LahUxCHv = 0; K8LahUxCHv < 16; K8LahUxCHv ++) {
      if (PNOyOWxJpK + K8LahUxCHv < sajdkj1.c0esYbnYow && JIGYRzzmas + lN3Q1bY4Lc < sajdkj1.pu0XGjLhxR) {
        draw_rect((Iu9obYq0S0[lN3Q1bY4Lc >> 1] >> (K8LahUxCHv >> 1)) & 1 ? &c3QL4Ztrp1 : &hlkzrt0baS, PNOyOWxJpK + K8LahUxCHv, JIGYRzzmas + lN3Q1bY4Lc, 1, 1);
      }
    }
  }
}
void jkjk91010(const char *sLmI1owfcc, int PNOyOWxJpK, int JIGYRzzmas) {
  while (*sLmI1owfcc) {
    fhsjkwiwiw11(*sLmI1owfcc ++, PNOyOWxJpK, JIGYRzzmas);
    if (PNOyOWxJpK + 16 >= sajdkj1.c0esYbnYow) {
...
struct J_Sl6Dag5p sajdkj1;
int block() {
  _ioe_init();
  while (1) {
    RsBhhiFFvE();
    while (1) {
      while (uptime() < sajdkj1.ukvKuleR4X) ;
      while ((sajdkj1.gZ5nzpxC8r = read_key()) != _KEY_NONE) {
        if (sajdkj1.gZ5nzpxC8r & 0x8000) continue;
        Wv1JqEgtYr(sajdkj1.gZ5nzpxC8r);
      }
      if (uptime() >= sajdkj1.h72Vdp9m1b) {
        if (!Wv1JqEgtYr(_KEY_NONE)) break;
        sajdkj1.h72Vdp9m1b += 1000 / 2;
      }
      draw_sync();
      sajdkj1.ukvKuleR4X += 1000 / 24;
    }
    while ((sajdkj1.gZ5nzpxC8r = read_key()) != _KEY_J) ;
  }
  return 0;
}
void RsBhhiFFvE() {
  sajdkj1.c0esYbnYow = screen_width();
  sajdkj1.pu0XGjLhxR = screen_height();
  sajdkj1.UaykZDyUUN = (sajdkj1.pu0XGjLhxR - 2) / 30;
  if (sajdkj1.c0esYbnYow / sajdkj1.UaykZDyUUN > 2 * 15) {
    sajdkj1.ufBizpkLbx.PNOyOWxJpK = (sajdkj1.c0esYbnYow - sajdkj1.UaykZDyUUN * 15) / 4;
    sajdkj1.ufBizpkLbx.JIGYRzzmas = (sajdkj1.pu0XGjLhxR - sajdkj1.UaykZDyUUN * 30) / 2;
  } else {
    sajdkj1.ufBizpkLbx.PNOyOWxJpK = 0;
    sajdkj1.ufBizpkLbx.JIGYRzzmas = (sajdkj1.pu0XGjLhxR - sajdkj1.UaykZDyUUN * 30) / 2;
  }
  sajdkj1.QkSY7m7Gvu.PNOyOWxJpK = sajdkj1.ufBizpkLbx.PNOyOWxJpK + sajdkj1.UaykZDyUUN * (15 + 3);
  sajdkj1.QkSY7m7Gvu.JIGYRzzmas = sajdkj1.ufBizpkLbx.JIGYRzzmas;
  sajdkj1.ukvKuleR4X = 0;
  sajdkj1.h72Vdp9m1b = 0;
  sajdkj1.vZkqLfCIMW = 0;
  sajdkj1.gZ5nzpxC8r = 0;
  fjksdfj(0, 0, sajdkj1.c0esYbnYow, sajdkj1.pu0XGjLhxR);
  printf("Welcome to TETRIS!\n");
  printf("Press SPACEBAR to start!\n");
  jkjk91010("Welcome to TETRIS!", 0, 0);
  jkjk91010("Press SPACEBAR to start!", 0, 16);
  draw_sync();
  while ((sajdkj1.gZ5nzpxC8r = read_key()) != _KEY_J) ;
  fjksdfj(0, 0, sajdkj1.c0esYbnYow, sajdkj1.pu0XGjLhxR);
  srand(uptime());
  sajdkj1.ukvKuleR4X = uptime();
  sajdkj1.h72Vdp9m1b = uptime();
  AlM0UT25fL();
}
void fjksdfj(int PNOyOWxJpK, int JIGYRzzmas, int IIsFjksDAJ, int ackFJ_S7eT) {
  ...
  for (int lN3Q1bY4Lc = 0; lN3Q1bY4Lc < ackFJ_S7eT; ++lN3Q1bY4Lc) {
    for (int K8LahUxCHv = 0; K8LahUxCHv < IIsFjksDAJ; ++K8LahUxCHv) {
      if ((PNOyOWxJpK + K8LahUxCHv >= 0 && PNOyOWxJpK + K8LahUxCHv < sajdkj1.c0esYbnYow)
          && (JIGYRzzmas + lN3Q1bY4Lc >= 0 && JIGYRzzmas + lN3Q1bY4Lc < sajdkj1.pu0XGjLhxR)) {
        draw_rect(&hlkzrt0baS, PNOyOWxJpK + K8LahUxCHv, JIGYRzzmas + lN3Q1bY4Lc, 1, 1);
      }
    }
  }
}
void jsuwjsuw21(struct Vyi8XZjDoj oT4p6Ulx7J, int t_Ond6SBcn, uint32_t T2Uhx4sRvS) {
...
struct akI2wblQIp tl7Kc3Gx6U(struct akI2wblQIp EBXJ01b3X8, int8_t fJYKmt6jcb) {
  ...
  HFiQY7M_0g.W2yp9bnpy5 = sajdkj1.PbckqMrTl2[0];
  if (ceO5NPYidU(HFiQY7M_0g)) {
    sajdkj1.PbckqMrTl2[0] = EBXJ01b3X8.W2yp9bnpy5;
    c8HmnZyjKm();
    return HFiQY7M_0g;
  } else {
    return EBXJ01b3X8;
...
struct akI2wblQIp Ni4LED3jUH(struct akI2wblQIp N4HsEUMz4N, int8_t UQhKx6F_4t) {
  ...
  if (UQhKx6F_4t || memcmp(&CmxyfEd65Y, &N4HsEUMz4N, sizeof(struct akI2wblQIp)) == 0) {
    if (!ceO5NPYidU(CmxyfEd65Y)) {
      ...
      wcwGfNsCkC();
      CmxyfEd65Y.oT4p6Ulx7J = dVcc1z7igq;
      CmxyfEd65Y.W2yp9bnpy5 = sajdkj1.PbckqMrTl2[0];
      for (int lN3Q1bY4Lc = 0; lN3Q1bY4Lc < 3 - 1; ++lN3Q1bY4Lc) sajdkj1.PbckqMrTl2[lN3Q1bY4Lc] = sajdkj1.PbckqMrTl2[lN3Q1bY4Lc + 1];
      sajdkj1.PbckqMrTl2[3 - 1] = pVquJtRsOw();
      if (ceO5NPYidU(CmxyfEd65Y)) {
        c8HmnZyjKm();
...
void wcwGfNsCkC() {
  for (int lN3Q1bY4Lc = 30 - 1; lN3Q1bY4Lc >= 0; --lN3Q1bY4Lc) {
    if (ngSRbtwYAy(lN3Q1bY4Lc)) {
      ...
      sajdkj1.vZkqLfCIMW += ZmBnADhg5k[Om5dYT6URx];
...
void ly0rql8X0e(struct Vyi8XZjDoj oT4p6Ulx7J, uint32_t SU7984_mkw) {
  ...
  struct Vyi8XZjDoj S63gJ0ohpw = {
    sajdkj1.ufBizpkLbx.PNOyOWxJpK + oT4p6Ulx7J.PNOyOWxJpK * sajdkj1.UaykZDyUUN,
    sajdkj1.ufBizpkLbx.JIGYRzzmas + oT4p6Ulx7J.JIGYRzzmas * sajdkj1.UaykZDyUUN
  };
  jsuwjsuw21(S63gJ0ohpw, sajdkj1.UaykZDyUUN, SU7984_mkw);
}
void m5miMmA7_2() {
  struct Vyi8XZjDoj Iu9obYq0S0;
  for (int lN3Q1bY4Lc = 0; lN3Q1bY4Lc < 2; ++lN3Q1bY4Lc) {
    Iu9obYq0S0.JIGYRzzmas = sajdkj1.ufBizpkLbx.JIGYRzzmas + 2 * sajdkj1.UaykZDyUUN - lN3Q1bY4Lc;
    for (int K8LahUxCHv = 0; K8LahUxCHv < 15 * sajdkj1.UaykZDyUUN; ++K8LahUxCHv) {
      Iu9obYq0S0.PNOyOWxJpK = sajdkj1.ufBizpkLbx.PNOyOWxJpK + K8LahUxCHv;
      jsuwjsuw21(Iu9obYq0S0, 1, 0xff0000);
    }
  }
}
...
void c8HmnZyjKm() {
  struct Vyi8XZjDoj Iu9obYq0S0;
  char l_HEevn9d3[16] = "";
  sprintf(l_HEevn9d3, "%d", sajdkj1.vZkqLfCIMW);
  fjksdfj(sajdkj1.QkSY7m7Gvu.PNOyOWxJpK - 3 * sajdkj1.UaykZDyUUN, 0, (3 + 6 * 3) * sajdkj1.UaykZDyUUN, sajdkj1.pu0XGjLhxR);
  jkjk91010("NEXT", sajdkj1.QkSY7m7Gvu.PNOyOWxJpK - sajdkj1.UaykZDyUUN, sajdkj1.QkSY7m7Gvu.JIGYRzzmas);
  for (int lN3Q1bY4Lc = 0; lN3Q1bY4Lc < 3; ++lN3Q1bY4Lc) {
    int W2yp9bnpy5 = sajdkj1.PbckqMrTl2[lN3Q1bY4Lc];
    for (int K8LahUxCHv = 0; K8LahUxCHv < 4; ++K8LahUxCHv) {
      Iu9obYq0S0.PNOyOWxJpK = sajdkj1.QkSY7m7Gvu.PNOyOWxJpK + cDu7PTAYYw[W2yp9bnpy5].IOjC2fkbCg[K8LahUxCHv].PNOyOWxJpK * sajdkj1.UaykZDyUUN;
      Iu9obYq0S0.JIGYRzzmas = sajdkj1.QkSY7m7Gvu.JIGYRzzmas + 32 + (2 + 6 * lN3Q1bY4Lc + cDu7PTAYYw[W2yp9bnpy5].IOjC2fkbCg[K8LahUxCHv].JIGYRzzmas) * sajdkj1.UaykZDyUUN;
      jsuwjsuw21(Iu9obYq0S0, sajdkj1.UaykZDyUUN, cDu7PTAYYw[W2yp9bnpy5].SU7984_mkw);
    }
  }
  jkjk91010("SCORE", sajdkj1.QkSY7m7Gvu.PNOyOWxJpK - sajdkj1.UaykZDyUUN, sajdkj1.QkSY7m7Gvu.JIGYRzzmas + 32 + (2 + 6 * 3) * sajdkj1.UaykZDyUUN);
  jkjk91010(l_HEevn9d3, sajdkj1.QkSY7m7Gvu.PNOyOWxJpK - sajdkj1.UaykZDyUUN, sajdkj1.QkSY7m7Gvu.JIGYRzzmas + 32 + (2 + 6 * 3) * sajdkj1.UaykZDyUUN + 16);
}
void oafzhQLGOL() {
  jkjk91010("Game Over", sajdkj1.QkSY7m7Gvu.PNOyOWxJpK - sajdkj1.UaykZDyUUN, sajdkj1.QkSY7m7Gvu.JIGYRzzmas + 32 + (2 + 6 * 3) * sajdkj1.UaykZDyUUN + 2 * 16);
}
